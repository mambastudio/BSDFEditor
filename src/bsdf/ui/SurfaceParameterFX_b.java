...
public class SurfaceParameterFX_b implements Serializable {
    ...
    public SurfaceParameter_b getSurfaceParameter()
    {
        ...
        param.diffuse_param.setValue(diffuse_param.getPoint3());
        param.glossy_color.setColorFX(glossy_color.get());
        param.glossy_param.setValue(glossy_param.getPoint3());
        param.mirror_color.setColorFX(mirror_color.get());
        param.mirror_param.setValue(mirror_param.getPoint3());
        param.emission_color.setColorFX(emission_color.get());
        param.emission_param.setValue(emission_param.getPoint3());
