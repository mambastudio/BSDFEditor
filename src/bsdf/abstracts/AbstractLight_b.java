 ...
 * @author user
 */
public interface AbstractLight_b 
{
    ...
    public Color4_b emit(
            SceneSphere_b aSceneSphere,
            Value2Df    aDirRndTuple,
            Value2Df    aPosRndTuple,
            Point3_b      oPosition,
            Vector3_b     oDirection,
            Value1Df    oEmissionPdfW,
            Value1Df    oDirectPdfA,
            Value1Df    oCosThetaLight);
    
    public Color4_b getRadiance(
            SceneSphere_b aSceneSphere,
            Vector3_b     aRayDirection,
            Point3_b      aHitPoint,
            Value1Df    oDirectPdfA,
            Value1Df    oEmissionPdfW);
